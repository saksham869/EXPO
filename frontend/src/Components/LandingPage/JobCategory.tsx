...
const JobCategory = () => {
    return <div className="mt-20 pb-5 overflow-hidden">
        <div data-aos="zoom-out" className="text-4xl  text-center font-semibold  md-mx:text-3xl sm-mx:text-2xl xs-mx:text-xl mb-3 text-mine-shaft-100"> Get a <span className="text-bright-sun-400">Job </span>
            Category</div>
        <div data-aos="zoom-out" className="text-lg sm-mx:text-base xs-mx:text-sm mb-10 mx-auto text-mine-shaft-300 text-center w-1/2 sm-mx:w-11/12">Apne skills ke hisaab se job explore karo, career shuru karo!</div>
