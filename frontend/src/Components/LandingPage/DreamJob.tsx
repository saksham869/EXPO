    ...
    return (
        <div className="flex sm-mx:flex-col-reverse  items-center px-16 bs-mx:px-10 md-mx:px-5">
            <div data-aos="zoom-out-right" className="flex flex-col w-[45%] sm-mx:w-full gap-3">
                <div className="text-6xl bs-mx:text-5xl md-mx:text-4xl sm-mx:text-3xl font-bold leading-tight text-mine-shaft-100 [&>span]:text-bright-sun-400">Udaan Bharo <span >Apne</span> <span>Carrer</span> Ke Sapno Ki !</div>
                <div className="text-lg md-mx:text-base sm-mx:text-sm text-mine-shaft-200">" Acchhi zinadgi shuru hoti hai ek acchi company ke sath Ek jagah par hazzaron naukariya ko explore karein".</div>
                    ...
                    <div className="absolute xs:-left-5 w-fit bs-mx:top-[35%] xs-mx:top-[60%] top-[28%] border-bright-sun-400 border xs-mx:!right-0 rounded-lg p-2 backdrop-blur-md gap-3 flex flex-col">
                        <div className="flex gap-2 items-center ">
                            ...
                            <div className="text-sm text-mine-shaft-100">
                                ...
                                <div className="text-mine-shaft-200 text-xs">Ghaziyabad</div>
                            </div>
                        </div>
                        <div className="flex gap-2 justify-around text-mine-shaft-200 text-xs">
                            <span>1 day ago</span>
                            <span>130 Applicants</span>
                        </div>
                    </div>
                </div>
            </div>
